...
export const OFF_ADV_PASSING_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "WPA", key: "off_pass_wpa", format: epa },
  { label: "WPA/Att", key: "off_pass_wpa_per_attempt", format: epa },
  { label: "WPA/Comp", key: "off_pass_wpa_per_completion", format: epa },
  { label: "WPA/Drop", key: "off_pass_wpa_per_dropback", format: epa },
...
export const OFF_ADV_RUSHING_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "WPA", key: "off_rush_wpa_total", format: epa },
  { label: "WPA/Att", key: "off_rush_wpa_per_attempt", format: epa },
...
export const OFF_TOTAL_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "WPA", key: "off_wpa", format: epa },
  { label: "WPA/Game", key: "off_wpa_per_game", format: epa },
  { label: "WPA/Play", key: "off_wpa_per_play", format: epa },
  { label: "WPA/Drive", key: "off_wpa_per_drive", format: epa },
...
export const OFF_SITUATIONAL_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "Early Down WPA", key: "off_early_down_wpa", format: epa },
  { label: "Early Down WPA/Play", key: "off_early_down_wpa_per_play", format: epa },
  ...
  { label: "Late Down WPA", key: "off_late_down_wpa", format: epa },
  { label: "Late Down WPA/Play", key: "off_late_down_wpa_per_play", format: epa },
];
...
export const DEF_ADV_PASSING_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "WPA", key: "def_pass_wpa", format: epa },
  { label: "WPA/Att", key: "def_pass_wpa_per_attempt", format: epa },
  { label: "WPA/Comp", key: "def_pass_wpa_per_completion", format: epa },
  { label: "WPA/Drop", key: "def_pass_wpa_per_dropback", format: epa },
...
export const DEF_ADV_RUSHING_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "WPA", key: "def_rush_wpa_total", format: epa },
  { label: "WPA/Att", key: "def_rush_wpa_per_attempt", format: epa },
...
export const DEF_TOTAL_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "WPA", key: "def_wpa", format: epa },
  { label: "WPA/Game", key: "def_wpa_per_game", format: epa },
  { label: "WPA/Play", key: "def_wpa_per_play", format: epa },
  { label: "WPA/Drive", key: "def_wpa_per_drive", format: epa },
...
export const DEF_SITUATIONAL_COLUMNS: TeamColumnDef[] = [
  ...
  { label: "Early Down WPA", key: "def_early_down_wpa", format: epa },
  { label: "Early Down WPA/Play", key: "def_early_down_wpa_per_play", format: epa },
  ...
  { label: "Late Down WPA", key: "def_late_down_wpa", format: epa },
  { label: "Late Down WPA/Play", key: "def_late_down_wpa_per_play", format: epa },
];
